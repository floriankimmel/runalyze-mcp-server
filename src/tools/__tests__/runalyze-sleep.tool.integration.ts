...
import { RunalyzeSleepTool } from '../runalyze-sleep.tool';

describe('RunalyzeSleepTool', () => {
  let tool: RunalyzeSleepTool;
  let mockContext: any;
  ...
  beforeEach(async () => {
    ...
    tool = module.get<RunalyzeSleepTool>(RunalyzeSleepTool);
  ...
  describe('getSleepData', () => {
    it('should successfully retrieve Sleep data', async () => {
      const mockData = [
        {
          id: 1,
      ...
      expect(mockFetch).toHaveBeenCalledWith('https://runalyze.com/api/v1/metrics/sleep?page=1', {
        method: 'GET',
        headers: {
    ...
    it('should handle pagination parameter', async () => {
      ...
      expect(mockFetch).toHaveBeenCalledWith(
        'https://runalyze.com/api/v1/metrics/sleep?page=3',
        expect.any(Object),
      );
    });
    ...
    it('should return error when API token is not configured', async () => {
      ...
      const toolNoToken = module.get<RunalyzeSleepTool>(RunalyzeSleepTool);
